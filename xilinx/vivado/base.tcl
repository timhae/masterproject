...
#
# Generated by Vivado on Mon Aug 09 11:46:54 CEST 2021
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../../../../../../../../../repos/PYNQ/boards/ip"]"]"\
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../../../../repos/bdf"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../../../../../../../repos/PYNQ/boards/ip"] [file normalize "$origin_dir/../ip"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  hls:accel:bitwise_and:1.0\
  hls:accel:bitwise_not:1.0\
  hls:accel:median:1.0\
  ...
  set add_0 [ create_bd_cell -type ip -vlnv hls:accel:add:1.0 add_0 ]
  ...
  # Create instance: bitwise_and_0, and set properties
  set bitwise_and_0 [ create_bd_cell -type ip -vlnv hls:accel:bitwise_and:1.0 bitwise_and_0 ]

  # Create instance: bitwise_and_1, and set properties
  set bitwise_and_1 [ create_bd_cell -type ip -vlnv hls:accel:bitwise_and:1.0 bitwise_and_1 ]

  # Create instance: bitwise_not_0, and set properties
  set bitwise_not_0 [ create_bd_cell -type ip -vlnv hls:accel:bitwise_not:1.0 bitwise_not_0 ]

  # Create instance: median_0, and set properties
  set median_0 [ create_bd_cell -type ip -vlnv hls:accel:median:1.0 median_0 ]
...
0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net add_0_img_out [get_bd_intf_pins add_0/img_out] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins axis_broadcaster_1/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins axi_dma_1/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins axi_mem_intercon/S05_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins bitwise_and_0/img_in1]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins bitwise_and_1/img_in1]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins axis_broadcaster_1/M00_AXIS] [get_bd_intf_pins bitwise_and_0/img_in2]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins bitwise_not_0/img_in1]
  connect_bd_intf_net -intf_net bitwise_and_0_img_out [get_bd_intf_pins add_0/img_in1] [get_bd_intf_pins bitwise_and_0/img_out]
  connect_bd_intf_net -intf_net bitwise_and_1_img_out [get_bd_intf_pins bitwise_and_1/img_out] [get_bd_intf_pins median_0/img_in1]
  connect_bd_intf_net -intf_net bitwise_not_0_img_out [get_bd_intf_pins bitwise_and_1/img_in2] [get_bd_intf_pins bitwise_not_0/img_out]
  connect_bd_intf_net -intf_net median_0_img_out [get_bd_intf_pins add_0/img_in2] [get_bd_intf_pins median_0/img_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins add_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_sg_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_mem_intercon/S05_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins bitwise_and_0/ap_clk] [get_bd_pins bitwise_and_1/ap_clk] [get_bd_pins bitwise_not_0/ap_clk] [get_bd_pins median_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins add_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_mem_intercon/S05_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins bitwise_and_0/ap_rst_n] [get_bd_pins bitwise_and_1/ap_rst_n] [get_bd_pins bitwise_not_0/ap_rst_n] [get_bd_pins median_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/base/base.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
